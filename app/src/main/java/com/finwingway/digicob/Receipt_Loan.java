...
public class Receipt_Loan extends Activity {
    String[] receiptArray,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sDate = intent.getStringExtra("TrnsDate");
        sTime = intent.getStringExtra("TrnsTime");
        sloanAccNo = intent.getStringExtra("loan_acc");
...
//        receiptArray = intent.getStringArrayExtra("receiptArray");
        ...
        tv_trans_date = (TextView) findViewById(R.id.receipt_ln_date_tv);
        tv_trans_time = (TextView) findViewById(R.id.receipt_ln_time_tv);
...
//        new getInstallmentDetails().execute();
        ...
        print.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(Receipt_Loan.this, "Print will not work in this device.!!", Toast.LENGTH_SHORT).show();
