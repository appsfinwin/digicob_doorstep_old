...
public class Receipt_Deposit extends Activity implements Runnable {
    ...
    TextView accountNO,Name,Mobile,oldBal,DepositAmount,currentBal,depositDate,depositTime;
    ...
    public void onCreate(Bundle bundle){
        ...
        final String deposit_amount = intent.getStringExtra("deposit_amount");
        final String current_balance = intent.getStringExtra("current_balance");
        final String deposit_date = intent.getStringExtra("deposit_date");
            ...
            public void onClick(View view) {
                ...
                if (mBluetoothAdapter == null) {
                    ...
                    if (!mBluetoothAdapter.isEnabled()) {
                        ...
                        ListPairedDevices();
                        Intent connectIntent = new Intent(Receipt_Deposit.this,DeviceListActivity.class);
                ...
                Thread t = new Thread() {
                    public void run() {
                        try {
                            ...
                            String BILL = "";
                            BILL = "\n             Bank Name               \n\n";
                            BILL = BILL + "Deposit Date     : " + deposit_date + "\n";
    ...
    public void onActivityResult(int mRequestCode, int mResultCode,
        ...
        switch (mRequestCode) {
            ...
            case REQUEST_ENABLE_BT:
                if (mResultCode == Activity.RESULT_OK) {
                    ListPairedDevices();
                    Intent connectIntent = new Intent(Receipt_Deposit.this,
                            DeviceListActivity.class);
                    startActivityForResult(connectIntent, REQUEST_CONNECT_DEVICE);
                } else {
                    Toast.makeText(Receipt_Deposit.this, "Bluetooth activate denied", Toast.LENGTH_SHORT).show();
                }
                break;
        }
    }
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            Toast.makeText(Receipt_Deposit.this, "DeviceConnected", Toast.LENGTH_LONG).show();
        }
    };
