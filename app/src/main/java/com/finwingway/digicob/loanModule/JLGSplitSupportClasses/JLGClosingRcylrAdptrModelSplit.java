...
public class JLGClosingRcylrAdptrModelSplit {
    ...
    public JLGClosingRcylrAdptrModelSplit(String _CustId, String _CustName, String _AccountNo, String _PrincipalBal, String _Interest,
