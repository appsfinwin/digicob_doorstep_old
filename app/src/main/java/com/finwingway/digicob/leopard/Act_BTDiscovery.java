...
public class Act_BTDiscovery extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState){
		...
		ActivityCompat.requestPermissions(Act_BTDiscovery.this,new String[]{ Manifest.permission.ACCESS_COARSE_LOCATION},1);
	...
	//Exit confirmation dialog box
		public void dlgExit() {
			...
			alertDialogBuilder.setMessage(
					"Do you want to cancel device search?");
		...
		switch(requestCode)
		{
			case 1:{
				if(grantResults.length > 0 &&  grantResults[0] == PackageManager.PERMISSION_GRANTED){
					...
					Toast.makeText(getBaseContext(), "Bluetooth Permission Denied", Toast.LENGTH_SHORT).show();
				}
				return;
			}
		}
